...
import time as t
import threading
#from buderus.steps import stepchain
from .steps import stepchain
...
class Dust3964r (stepchain,Serial):
    ...
    #get safe in Buffer with exception handling   
    def safeInBuffer(self):
        try:
            inBuffer = self.RS232.inWaiting ()
        except IOError:
            print("I/O error in inWaiting()")
            inBuffer = 0
        return inBuffer
    ...
    def schritt_0 (self):
        ...
        if self.safeInBuffer () and self.RealRun:
